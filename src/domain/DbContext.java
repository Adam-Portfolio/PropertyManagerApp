...
public class DbContext {
    ...
    public static ArrayList<Person> getPeople() {
        ...
        persons.add(new Person(1,"Adam","Fravel","afravel"));
        persons.add(new Person(2,"Madeline","Kingsbury","mkingsbury"));
        persons.add(new Person(3,"Rossana","Rowland","rrowland"));
        persons.add(new Person(4,"Marilyn","Charles","mcharles"));
        persons.add(new Person(5,"Mary","Dimick","mdimick"));
        return persons;
    }
}